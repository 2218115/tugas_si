        ...
        <div class="card">
            <div class="card-header">
               <h3>Data Detail Transaksi</h3>                   
                ...
                <a href="/admin/transaksi-penjualan/detail/{{$transaksiPenjualan->id_transaksi_penjualan}}/report" class="btn icon icon-left btn-success"> <i data-feather="printer" width="20"></i> Cetak</a>
            </div>
            <div class="card-body">
                <div class="row">
                    @switch($transaksiPenjualan->status)
                        ...
                        @case('DI_DISTRIBUSIKAN')
                            <div class="alert alert-primary">
                                ...
                                <p>Transaksi Di Distribusikan</p>
                            </div>
                            @break
                        @case('SELESAI')
