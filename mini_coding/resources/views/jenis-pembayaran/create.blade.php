...
<div class="main-content container-fluid">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-vertical" action="/admin/jenis-pembayaran" method="POST">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label for="jenis">Jenis Pembayaran</label>
                                <input type="text" name="jenis" class="form-control" placeholder="Masukkan nama jenis pembayaran" id="first-name-icon">
                                @error('jenis')
